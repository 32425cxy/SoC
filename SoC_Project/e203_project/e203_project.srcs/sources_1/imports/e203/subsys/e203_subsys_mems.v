...
//    .axi_awvalid   (expl_axi_awvalid),1
//    .axi_awready   (expl_axi_awready),1
//    .axi_awaddr    (expl_axi_awaddr ),1
//    .axi_awcache   (expl_axi_awcache),
//    .axi_awprot    (expl_axi_awprot ),
//    .axi_awlock    (expl_axi_awlock ),
//    .axi_awburst   (expl_axi_awburst),1
//    .axi_awlen     (expl_axi_awlen  ),1
//    .axi_awsize    (expl_axi_awsize ),1
...
blk_mem_gen_0 ram_zero (
  .s_aclk(clk),                // input wire s_aclk
  .s_aresetn(rst_n),          // input wire s_aresetn
  .s_axi_awaddr(expl_axi_awaddr),    // input wire [31 : 0] s_axi_awaddr
  .s_axi_awvalid(expl_axi_awvalid),  // input wire s_axi_awvalid
  .s_axi_awready(expl_axi_awready),  // output wire s_axi_awready
  .s_axi_wdata(expl_axi_wdata),      // input wire [31 : 0] s_axi_wdata
  .s_axi_wstrb(expl_axi_wstrb),      // input wire [3 : 0] s_axi_wstrb
  .s_axi_wvalid(expl_axi_wvalid),    // input wire s_axi_wvalid
  .s_axi_wready(expl_axi_wready),    // output wire s_axi_wready
  .s_axi_bresp(expl_axi_bresp),      // output wire [1 : 0] s_axi_bresp
  .s_axi_bvalid(expl_axi_bvalid),    // output wire s_axi_bvalid
  .s_axi_bready(expl_axi_bready),    // input wire s_axi_bready
  .s_axi_araddr(expl_axi_araddr),    // input wire [31 : 0] s_axi_araddr
  .s_axi_arvalid(expl_axi_arvalid),  // input wire s_axi_arvalid
  .s_axi_arready(expl_axi_arready),  // output wire s_axi_arready
  .s_axi_rdata(expl_axi_rdata),      // output wire [31 : 0] s_axi_rdata
  .s_axi_rresp(expl_axi_rresp),      // output wire [1 : 0] s_axi_rresp
  .s_axi_rvalid(expl_axi_rvalid),    // output wire s_axi_rvalid
  .s_axi_rready(expl_axi_rready)    // input wire s_axi_rready
);
